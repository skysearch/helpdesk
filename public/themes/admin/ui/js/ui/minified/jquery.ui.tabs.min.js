...
(function(e,t){
    ...
    e.widget("ui.tabs",{
        ...
        _getList:function(){
            return this.element.find("li.nav-tabs ol,li.nav-tabs ul").eq(0)
        },
        _createPanel:function(t){
            return e("<fieldset>").attr("id",t).addClass("ui-tabs-panel ui-widget-content ui-corner-bottom").data("ui-tabs-destroy",!0)
        },
