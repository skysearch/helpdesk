...
class Sky_Image_ImageMagick extends Sky_Image_Abstract
{
	...
	public function flip($newFile, $mode)
	{
		...
		switch ($mode) {
			case Sky_Image_Abstract::FLIP_VERTICAL:
				$imagick->flipImage();
				break;
			case Sky_Image_Abstract::FLIP_HORIZONTAL:
				$imagick->flopImage();
				break;
		}
