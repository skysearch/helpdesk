...
class Sky_Form_Validate_RecordNoExist extends Zend_Validate_Abstract {

    protected $_repository;
    protected $_function;
    
    const RECORD_EXISTS = 'recordNoExists';

    protected $_messageTemplates = array(
	  self::RECORD_EXISTS => 'O valor %value% não existe na base de dados!'
	);
