...
class Admin_Forms_Nivel extends Sky_Form_Jquery_Form {
    ...
    public function init() {
        ...
        foreach ($resources as $resource) {
            $privileges = $acl->getPrivilegesByResource($resource['module_name'], $resource['controller_name']);
            ...
            $element_name = "{$resource['module_name']}_{$resource['controller_name']}";
