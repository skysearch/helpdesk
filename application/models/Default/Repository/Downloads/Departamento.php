...
class Application_Model_Default_Repository_Downloads_Departamento extends Sky_Db_Repository_Abstract {
    ...
    public function getComboOptions($filter=null,$primary='departamento_id',$value='nome',$empty=true){
        $helper = $this->getHelper('DataCombo');
        return $helper->getDataCombo($primary,$value,$this->getAll($filter),$empty);
    }
