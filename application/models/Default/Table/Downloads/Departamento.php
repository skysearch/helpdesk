 ...
 * @author Renato David
 */
class Application_Model_Default_Table_Downloads_Departamento extends Sky_Db_Table_Abstract {
    //put your code here
    protected $_name = 'tic_departamento';
    protected $_primary = array('departamento_id');
    protected $_dependentTables = array('Application_Model_Default_Table_Downloads_Pasta');
