 ...
 * @author Renato David
 */
class Application_Model_Default_Table_Api_Rule extends Sky_Db_Table_Abstract {

    //put your code here
    protected $_name = 'api_rule';
    protected $_primary = array('rule_id');
    protected $_referenceMap = array(
        'Privilege' => array(
            'columns' => array('privilege_id'),
            'refTableClass' => 'Application_Model_Table_Api_Privilege',
        ...
        'Role' => array(
            ...
            'refTableClass' => 'Application_Model_Table_Api_Role',
