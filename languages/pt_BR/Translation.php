...
return array(
    ...
    "No token was provided to match against" => "Você demorou muito tempo para submeter o formulário, tente novamente",
	"The two given tokens do not match"=>"A senha confirmada está diferente da digitada no campo senha",
	"A record with the supplied identity could not be found."=>"Usuário inexistente.",
	"Supplied credential is invalid."=>"Senha fornecida é inválida.",
    ...
    "'%value%' must contain at least one uppercase letter"=>"A senha precisa conter pelo menos uma letra maiúscula",
    "'%value%' must contain at least one lowercase letter"=>"A senha precisa conter pelo menos uma letra minúscula",
    "'%value%' must contain at least one digit character"=>"A senha precisa conter pelo menos um número",
    "Google Maps"=>"Digite um CEP",
);
